import {
  ...
  export class CustomerPlugin extends DestinationPlugin {
    ...
    async update(settings: SegmentAPISettings, _: UpdateType): Promise<void> {
      ...
      console.log("appsflyerSettings", appsflyerSettings);
      ...
      if (!this.hasInitialized) {
        try {
          ...
          env.siteId = "c655aa89d78627cd20be";
          env.apiKey = "69bc72049860cade625a";
          ...
          const message = 'CustomerIO failed to initialize';
